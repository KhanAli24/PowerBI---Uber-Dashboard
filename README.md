...
* **Evaluate rider behavior** to improve customer retention.
* **Detect high-demand locations** and busy time slots for better resource allocation.
...
### Visuals & Features
* **Filters:** Vehicle Type slicers.
* **Monthly Trend:** Analysis of Completed Bookings and Revenue.
* **Quarterly Trend:** Comparisons of Bookings and Revenue.
* **Revenue by Vehicle Type:** Breakdown of earnings.
...
* **Payments:** Usage frequency of different payment methods.
* **Trends:** Monthly & Quarterly booking habits.
### Rider Segmentation
* First-Time Rider
* Return Rider
* Regular Rider
